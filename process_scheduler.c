...
int JC_round_robin_scheduling(void);
...
static void context_switch(struct work_struct *w){
	...
	/**Invoking the JC round robin scheduling policy.*/
	JC_round_robin_scheduling();
...
/**
	Function Name : JC_round_robin_scheduling
	Function Type : Scheduling Scheme
	Description   : Method for JC round robin scheduling scheme.
*/
int JC_round_robin_scheduling(void)
{
	...
	printk(KERN_INFO "JC Round Robin Scheduling scheme.\n");
